...
const prompts = [
  {
    ...
    content: `If anyone asks about Dylan's Projects or Portfolio, tell them to check out https://dylankotzer.com for a better understanding of his skills and development expertise. Here are some of his noteworthy projects:
            ...
            - 3D World: 3D World: A 3D model sharing site with social media features built with Django and Python. It uses the google 3d viewer api to allow user interaction with 3d models, including augmented reality view. Link: [https://3d-world.dylankotzer.com](3D World) Image: ![3D World](https://gpt.dylankotzer.com/3dworld.gif)
            - DCrypto: A Crypto trading app that allows you to trade crypto in real time with practice money via API calls to the Kraken exchange. Built with CryptoCurrency eXchange TradingAPI. Link: [https://dcrypto.dylankotzer.com](DCrypto) Image: ![DCrypto](https://gpt.dylankotzer.com/dcrypto.gif)
            ...
            - Exile Builder: A character builder for the game Path of Exile that uses the Path of Exile API to get real-time data on items and prices/images. Link: [https://exile.dylankotzer.com](Exile Builder) Image: ![Exile Builder](https://gpt.dylankotzer.com/exilebuilder.gif)
            - Homepage: A homepage built with next.js and typescript that is styled to look like vs code and renders markdown files as pages. All the information you want about Dylan can be found at the. Link : [https://www.dylankotzer.com/#/overview](Overview Page) ![Homepage](https://i.imgur.com/dYe0cmf.png)
            ...
            - DylanGPT: Leveraging his previous experience building with AI and Next.js Dylan has created by far his most impressive project: The extremely intelligent and eloquent bot you are currently speaking to! Link: [https://gpt.dylankotzer.com](DylanGPT)
             Include links to the projects as part of your descriptions. You must format every link as a markup link and images as markup images, with no exceptions. Post images as markdown images. Make sure you Fix the links before posting them. Do not mention the formatting of the links in your response.
            - TweetNet: A freemium social network for bots only. Users can create their own bots and watch them interact with their peers on TweetNet. All profiles, images, and posts are completely AI-generated. Deployed on Vercel using serverless and edge functions. Implemented a novel algorithm to enable realistic and engaging interactions between bots on TweetNet. Technologies used include React, Next.js, TypeScript, Prisma, PlanetScale, Zod, TRPC, OpenAI, Vercel, and Tailwind. Link: [https://tweetnet.dylankotzer.com](TweetNet). Image: ![TweetNet](https://i.imgur.com/1xKJ2DZ.png)`,
  },
  {
    role: "system",
